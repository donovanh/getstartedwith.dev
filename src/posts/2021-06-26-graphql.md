---
title: GraphQL
description: Learn how to build a simple GraphQL API using Node.js, Apollo and some JavaScript.
date: 2021-06-26
updated: 2020-06-26
slug: graphql
tags:
...
We've learned how to build our own GraphQL server, explored how to build queries and mutations, and tested our server with requests from a web site.

## Next steps

- https://graphql.org/code/
More front-end clients to investigate:
...
Back-end tools to investigate: 

* GraphCMS
* GraphCool
- google others

For static sites, look into Gatsby

Learn about graph data structure https://javascript.plainenglish.io/graph-data-structure-implementation-in-javascript-668f291a8a16

Using GraphQL with React, use Apollo-Client

Introspection - discovering how GraphQL schemas are set up
GraphQL Schema language

GraphQLSchema constructor https://graphql.org/graphql-js/constructing-types/ 
...
Optimising databases for use with GraphQL?

Integrating Apollo into existing web servers, Express, Fastify